...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='image',
            field=models.ImageField(blank=True, default='static/images/logo.jpg', upload_to='images/'),
        ),
        migrations.AlterField(
            model_name='post',
            name='item_type',
            field=models.CharField(choices=[('필기류', '필기류'), ('지갑', '지갑'), ('전자기기', '전자기기'), ('의류', '의류'), ('신분증/카드', '신분증/카드'), ('기타', '기타')], default='필기구', max_length=10),
        ),
        migrations.AlterField(
            model_name='post',
            name='kept_place',
